  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          return Scaffold(
            ...
            body: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                final String priceText = ingredients[index].parsePriceToString();
                final String measureText = ingredients[index].parseValueToString();
                ...
                return CustomCard(
                  title:
                      "${ingredients[index].name} - $measureText${ingredients[index].mesuarementUnit.name}",
        ...
        return Center(
          child: Text('Sem dados.', style: TextStyle(color: AppColors.primary)),
        );
      },
    );
  }
