...
Future<bool?> showCostsDialog(
  ...
  FixedCost cost = editing ? costs[index] : FixedCost(name: "");
      ...
      return StatefulBuilder(
        builder: (context, setState) {
          ...
          Future<void> handleDelete() async {
            final ReqExeption response = await deleteCostsData(cost.toMap());
